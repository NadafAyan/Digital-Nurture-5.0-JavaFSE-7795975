public class Cart {
    ...
    public void shuffleOrders() {
        orders[0] = new Order(1, "Ayan", 2043);
        orders[1] = new Order(2, "Almas", 2442);
        orders[2] = new Order(3, "Vaibhav", 1333);
        orders[3] = new Order(4, "Yash", 8984);
        orders[4] = new Order(5, "Nikita", 4545);
        orders[5] = new Order(6, "Punam", 7954);
        orders[6] = new Order(7, "Niket", 2312);
        orders[7] = new Order(8, "Kaushalya", 9535);
        orders[8] = new Order(9, "Komal", 8972);
        orders[9] = new Order(10, "Ankit", 2411);
    }
